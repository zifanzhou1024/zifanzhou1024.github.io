---
layout: single
title: "Investment Research Memo 02/17/2026"
date: 2026-02-17
author_profile: true
---
...
|:---------|:--------|:--------------------|:-------------------------------------------------------------------------|
| `$SPX`   | Bear    | 6840 / November Low | Watching for double top confirmation and moving average trio breakdown.  |
| `$COMPQ` | Bear    | November Low        | Failed trendline backtest; highly vulnerable to 40% tech bubble fractal. |
| `$DJI`   | Bear    | 50,000              | Rising wedge approaching apex; watching for `^DJT` non-confirmation.     |
| `$IWM`   | Neutral | Trendline Support   | Flat, forming an ascending broadening wedge; diverged from S&P in Jan.   |
| `$NVDA`  | Neutral | 200 EMA             | High-risk hold ahead of Feb 25 earnings; sideways since Sept in H&S.     |
| `$US10Y` | Bull    | N/A                 | Inverse H&S forming; Friday's macro events could trigger a yield spike.  |
| `$VIX`   | Bull    | 50-MA Support       | Tightly coiled; ready for expansion on an equity breakdown.              |
| `$BTC`   | Bear    | N/A                 | Leading indicator for risk-off liquidity; already crashed 52%.           |
| `^DJT`   | Bear    | N/A                 | Diverging from the Dow Industrials; classic top signal.                  |